...
internal sealed class NetworkMessageParameterModel : IEquatable<NetworkMessageParameterModel> {
	...
	public bool Equals(NetworkMessageParameterModel? other) {
	...
	public override bool Equals(object? obj) {
		return obj is NetworkMessageParameterModel other && Equals(other);
	}
