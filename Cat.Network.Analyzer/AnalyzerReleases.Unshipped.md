...
---------|----------|----------|------------------------------------------------------------------------
 ...
 CN0022  | Usage    | Error    | RPCAttribute and BroadcastAttribute require concrete non-virtual instance, non-generic partial void methods without ref, out, or in parameters
 ...
 CN0028  | Usage    | Error    | NetworkPropertyAttribute requires a supported property type
 CN0030  | Usage    | Error    | NetworkPropertyAttribute requires supported declaration modifiers
 CN0031  | Usage    | Error    | NetworkCollectionAttribute requires supported declaration modifiers
